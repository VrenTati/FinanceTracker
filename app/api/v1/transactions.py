...
from core.schemas.transaction import BaseTransaction, BaseTransactionCreate, BaseTransactionUpdate
...
async def update_transaction(
    ...
    return await TransactionService.update_transaction(db, transaction_id, transaction, user_id)
